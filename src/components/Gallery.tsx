...
const Gallery = () => (
  <section className="wrapper style1 align-center">
    ...
    <div className="gallery style2 medium lightbox onscroll-fade-in">
      ...
      <article>
        <a href="assets/images/gallery/fulls/06.jpg" className="image">
      ...
      <article>
        <a href="assets/images/gallery/fulls/07.jpg" className="image">
      ...
      <article>
        <a href="assets/images/gallery/fulls/08.jpg" className="image">
      ...
      <article>
        <a href="assets/images/gallery/fulls/09.jpg" className="image">
      ...
      <article>
        <a href="assets/images/gallery/fulls/10.jpg" className="image">
      ...
      <article>
        <a href="assets/images/gallery/fulls/11.jpg" className="image">
      ...
      <article>
        <a href="assets/images/gallery/fulls/12.jpg" className="image">
